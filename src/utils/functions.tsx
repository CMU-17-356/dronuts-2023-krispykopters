import {Donut as DonutType, DonutItems, cartItem, Order, Drone} from "../../types";
import {
    firebaseAddToCart,
...
import {Donut, IDonut} from "../../server/db/donut";
import {Types} from "mongoose";
import {Customer, ICustomer} from "../../server/db/customer";

export const addToCart = async (
    cartItems: cartItem[],
    DonutItems: DonutType[],
    user: any,
    fid: number,
    dispatch: any
) => {
...
export const getFoodyById = (menu: DonutType[], fid: number) => {
    return menu.find((item: DonutType) => item.id === fid);
};
